...
public class DBGarbageNoteHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "GarbageNote";

    // Table name: Note.
    private static final String TABLE_NOTE = "GarbageNote";
    ...
    public DBGarbageNoteHelper(@Nullable Context context) {
    ...
    public void createDefaultNotesIfNeed() {
        ...
        if (count == 0) {
            Note note1 = new Note("Firstly see Android ListView",
                    "See Android ListView Example in o7planning.org", "7/5/2020 4:11");
            Note note2 = new Note("Learning Android SQLite",
                    "See Android SQLite Example in o7planning.org", "7/5/2020 4:12");
            this.addNote(note1);
            this.addNote(note2);
        }
    }
    ...
    public Note getNote(int id) {
        ...
        Cursor cursor = db.query(TABLE_NOTE, new String[]{COLUMN_NOTE_ID,
                        COLUMN_NOTE_TITLE, COLUMN_NOTE_CONTENT, COLUMN_NOTE_DATE}, COLUMN_NOTE_ID + " = ?",
